                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <form method="POST" action="{{ route('password.update') }}">
                                            ...
                                            <div class="row mb-3">
                                                <label for="email" class="col-md-4 label-fgpw text-md-end">{{ __('EMAIL ADDRESS') }}</label>
                                            ...
                                            <div class="row mb-3">
                                                <label for="password" class="col-md-4 label-fgpw text-md-end">{{ __('PASSWORD') }}</label>
                                            ...
                                            <div class="row mb-3">
                                                <label for="password-confirm" class="col-md-4 label-fgpw text-md-end">{{ __('COMFIRM PASSWORD') }}</label>
