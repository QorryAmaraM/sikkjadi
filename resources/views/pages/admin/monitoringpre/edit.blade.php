...
@section('content')
   ...
   <div class="container-fluid">
      ...
      <form action="/monitoring/monitorinpre/{{ $monitoringpresensi->id }}" method="POST">
         @csrf
         @method('put')
         ...
         <div class="row mb-8">
            <div class="col-sm-7">
                <div class="form-group d-flex align-items-center">
                    ...
                    <input type="nama" class="form-control col-sm-10" id="nama" placeholder="Lorem Ipsum" name="nama" value="{{ $monitoringpresensi->nama }}">
                </div>
                <div class="form-group d-flex align-items-center">
                    <label for="nip" class="col-sm-2 pl-0 col-form-label">NIP</label>
                    <input type="nip" class="form-control col-sm-10" id="nip" placeholder="12345" name="nip" value="{{ $monitoringpresensi->nip }}">
                </div>
                <div class="form-group d-flex align-items-center">
                    <label for="tahun" class="col-sm-2 pl-0 col-form-label">Tahun</label>
                    <input type="tahun" class="form-control col-sm-10" id="tahun" placeholder="12345" name="tahun" value="{{ $monitoringpresensi->tahun }}">
                </div>
                <div class="form-group d-flex align-items-center">
                    <label for="bulan" class="col-sm-2 pl-0 col-form-label">Bulan</label>
                    <input type="bulan" class="form-control col-sm-10" id="bulan" placeholder="12345" name="bulan" value="{{ $monitoringpresensi->bulan }}">
                </div>
            </div>
        </div>
        ...
        <div class="row mb-8">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="nomor" class="form-control" id="nomor" placeholder="Lorem Ipsum Dolor Sit Amet" name="no" value="{{ $monitoringpresensi->no }}">
                </div>
                <div class="form-group">
                    <label for="kode">Kode</label>
                    <input type="kode" class="form-control" id="kode" placeholder="Lorem Ipsum Dolor Sit Amet" name="kode" value="{{ $monitoringpresensi->kode }}">
                </div>
                <div class="form-group">
