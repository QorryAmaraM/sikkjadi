      ...
      @section('content')
         ...
         <div class="container-fluid">
            ...
            <form action="/perencanaankerja/rencanakinerja/store" method="POST">
               @csrf
               ...
               <div class="row mb-8">
                  <div class="col-sm-12">
                     <div class="form-group d-flex align-items-center">
                        ...
                        <input type="nama" class="form-control col-sm-11" id="nama" placeholder="Lorem Ipsum" name="nama">
                     </div>
                     <div class="form-group d-flex align-items-center">
                        <label for="tahun" class="col-sm-1 pl-0 col-form-label">Tahun</label>
                        <input type="tahun" class="form-control col-sm-11" id="tahun" placeholder="2023" name="tahun">
                     </div>
                     <div class="form-group d-flex align-items-center">
                        <label for="periode" class="col-sm-1 pl-0 col-form-label">Periode</label>
                        <input type="periode" class="form-control col-sm-11" id="periode" placeholder="5 Januari - 23 Desember" name="periode">
                     </div>
                     <div class="form-group d-flex align-items-center">
                        <label for="wilayah" class="col-sm-1 pl-0 col-form-label">Wilayah</label>
                        <input type="wilayah" class="form-control col-sm-11" id="wilayah" placeholder="Pusat" name="wilayah">
                     </div>
                     <div class="form-group d-flex align-items-center">
                        <label for="unitkerja" class="col-sm-1 pl-0 col-form-label">Unit Kerja</label>
                        <input type="unitkerja" class="form-control col-sm-11" id="unitkerja" placeholder="Pusat Pendidikan dan Pelatihan" name="unit_kerja">
                     </div>
                     <div class="form-group d-flex align-items-center">
