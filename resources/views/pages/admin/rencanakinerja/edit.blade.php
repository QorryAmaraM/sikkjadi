            ...
            <div class="row mb-8">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="iki" class="form-control" id="rencana_kinerja_atasan" name="rencana_kinerja_atasan" value="{{ $rencanakinerja->rencana_kinerja_atasan }}">
                    </div>
                    <div class="form-group">
                        <label for="iki">Rencana Kinerja</label>
                        <input type="iki" class="form-control" id="rencana_kinerja" name="rencana_kinerja" value="{{ $rencanakinerja->rencana_kinerja }}">
                    </div>
                </div>
            </div>
