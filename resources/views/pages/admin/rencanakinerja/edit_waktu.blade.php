            ...
            <div class="row mb-8">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="iki" class="form-control" id="waktu_iki" name="waktu_iki" value="{{ $rencanakinerja->waktu_iki }}">
                    </div>
                    <div class="form-group">
                        <label for="targetmin">Target Min</label>
                        <input type="targetmin" class="form-control" id="waktu_target_min" name="waktu_target_min" value="{{ $rencanakinerja->waktu_target_min }}">
                    </div>
                    <div class="form-group">
                        <label for="targetmix">Target Max</label>
                        <input type="targetmix" class="form-control" id="waktu_target_max" name="waktu_target_max" value="{{ $rencanakinerja->waktu_target_max }}">
                    </div>
                    <div class="form-group">
                        <label for="satuan">Satuan</label>
                        <input type="satuan" class="form-control" id="waktu_satuan" name="waktu_satuan" value="{{ $rencanakinerja->waktu_satuan }}">
                    </div>
                </div>
            </div>
