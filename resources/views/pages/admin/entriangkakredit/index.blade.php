            ...
            <form action="/admin-masterangkakredit/entriangkakredit/store"  method="POST">
               ...
               <div class="row mb-8">
                  <div class="col-sm-12"> 
                     ...
                     <div class="form-group d-flex align-items-center">
                           ...
                           <input type="kodebutir" class="form-control col-sm-10" name="kode_butir" placeholder="Lorem Ipsum">
                        </div>
                        <div class="form-group d-flex align-items-center">
                        ...
                        <div class="form-group d-flex align-items-center">
                           ...
                           <input type="angkakredit" class="form-control col-sm-10" name="angka_kredit" placeholder="5 Januari - 23 Desember">
                        </div>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-sm-12 mt-3 text-right">
                      <button type="submit" name="submit" value="Save" class="btn save-button" data-toggle="modal" data-target="#successModal">+ Tambah</button>
                  </div>
              </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="'/admin-masterangkakredit/listangkakredit/'">Tutup</button>
                    </div>
                </div>
            </div>
        </div>
