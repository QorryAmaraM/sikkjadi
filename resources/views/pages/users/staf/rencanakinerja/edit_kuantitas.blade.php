            ...
            <div class="row mb-8">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="iki" class="form-control" id="kuantitas_iki" name="kuantitas_iki" value="{{ $rencanakinerja->kuantitas_iki }}" required>
                    </div>
                    <div class="form-group">
                        <label for="targetmin">Target Min</label>
                        <input type="targetmin" class="form-control" id="kuantitas_target_min" name="kuantitas_target_min" value="{{ $rencanakinerja->kuantitas_target_min }}" required onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                    </div>
                    <div class="form-group">
                        <label for="targetmix">Target Max</label>
                        <input type="targetmix" class="form-control" id="kuantitas_target_max" name="kuantitas_target_max" value="{{ $rencanakinerja->kuantitas_target_max }}" required onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                    </div>
                    <div class="form-group">
                        <label for="satuan">Satuan</label>
                        <input type="satuan" class="form-control" id="kuantitas_satuan" name="kuantitas_satuan" value="{{ $rencanakinerja->kuantitas_satuan }}" required>
                    </div>
                </div>
            </div>
