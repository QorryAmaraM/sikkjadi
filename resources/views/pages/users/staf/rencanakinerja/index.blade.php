...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 d-flex justify-content-end align-items-center mb-2">
                <a href="/staf-perencanaankerja/rencanakinerja/create/index" type="button" class="btn add-button">+
                    Tambah</a>
            </div>
        </div>
                        ...
                        <tbody class="alldata">
                            @forelse ($resultrole as $rencana)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-icon btn-edit btn-sm">
                                            <a href="{{ route('staf.kuantitas.edit', ['id' => $rencana->id]) }}"
                                    ...
                                    <td rowspan="3">
                                        <button class="btn btn-icon btn-edit btn-sm">
                                            <a href="{{ route('staf.rencanakinerja.edit', ['id' => $rencana->id]) }}" class="action-link"><i class="fas fa-edit"></i></a>
                                        </button>
                                        <button class="btn btn-icon btn-delete btn-sm" data-delete-url="{{ route('staf.rencanakinerja.delete', ['id' => $rencana->id]) }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-icon btn-edit btn-sm">
                                            <a href="{{ route('staf.kualitas.edit', ['id' => $rencana->id]) }}"
                                                class="action-link"><i class="fas fa-edit"></i></a>
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-icon btn-edit btn-sm">
                                            <a href="{{ route('staf.waktu.edit', ['id' => $rencana->id]) }}"
                                                class="action-link"><i class="fas fa-edit"></i></a>
                                        </button>
                                    </td>
                                </tr>
    ...
    <script>
        ...
        function handleSearch(value, tahunValue, periodeValue, wilayahValue, unitkerjaValue, Data) {
            $.ajax({
                type: 'get',
                url: '{{ URL::to('/staf-perencanaankerja/rencanakinerja/search') }}',
                data: {
                    'search': value,
                    'tahun': tahunValue,
