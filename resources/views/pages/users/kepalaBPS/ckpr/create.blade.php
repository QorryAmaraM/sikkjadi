...
@section('content')
   ...
   <div class="container-fluid">
      ...
      <form action="/kepalabps-ckp/ckpr/store" method="POST">
         @csrf
            ...
            <div class="col-sm-12">
               ...
               <div class="form-group">
                  <label for="keterangan">Keterangan</label>
                     <input type="keterangan" class="form-control" id="keterangan" placeholder="Lorem Ipsum Dolor Sit Amet" name="keterangan">
               </div>
            </div>
         </div>
