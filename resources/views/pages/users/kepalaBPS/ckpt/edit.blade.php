...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Content Row -->
        <form action="/kepalabps-ckp/ckpt/{{ $ckpt->id }}" method="POST">
            @csrf
            @method('put')
            <div class="row mb-8">
                <div class="col-sm-12">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group d-flex align-items-center">
                            ...
                            <input type="tahun" class="form-control col-sm-11" id="tahun"
                                placeholder="5 Januari - 23 Desember" name="tahun" value="{{ $ckpt->tahun }}">
                        </div>
                        <div class="form-group d-flex align-items-center">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="nomor" class="form-control" id="nomor"
                                placeholder="Lorem Ipsum Dolor Sit Amet" name="no" value="{{ $ckpt->no }}">
                        </div>
                        <div class="form-group">
                            <label for="fungsi">Fungsi</label>
                            <input type="fungsi" class="form-control" id="fungsi"
                                placeholder="Lorem Ipsum Dolor Sit Amet" name="fungsi" value="{{ $ckpt->fungsi }}">
                        </div>
                        <div class="form-group">
                            <label for="periode">Periode</label>
                            <input type="periode" class="form-control" id="periode"
                                placeholder="Lorem Ipsum Dolor Sit Amet" name="periode" value="{{ $ckpt->periode }}">
                        </div>
                        <div class="form-group">
                            <label for="kegiatan">Uraian Kegiatan</label>
                            <input type="kegiatan" class="form-control" id="kegiatan"
                                placeholder="Lorem Ipsum Dolor Sit Amet" name="uraian_kegiatan"
                                value="{{ $ckpt->uraian_kegiatan }}">
                        </div>
                        <div class="form-group">
                            <label for="satuan">Satuan</label>
                            <input type="satuan" class="form-control" id="satuan"
                                placeholder="Lorem Ipsum Dolor Sit Amet" name="satuan" value="{{ $ckpt->satuan }}">
                        </div>
                        <div class="form-group">
                            <label for="target">Target</label>
                            <input type="target" class="form-control" id="target"
                                placeholder="Lorem Ipsum Dolor Sit Amet" name="target" value="{{ $ckpt->satuan }}">
                        </div>
                        <div class="form-group">
                            <label for="kodebutir">Kode Butir</label>
                            <input type="kodebutir" class="form-control" id="kodebutir"
                                placeholder="Lorem Ipsum Dolor Sit Amet" name="kode_butir"
                                value="{{ $ckpt->kode_butir }}">
                        </div>
                        <div class="form-group">
