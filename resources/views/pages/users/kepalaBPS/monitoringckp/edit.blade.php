                    ...
                    <div class="row mb-8">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" max="100" class="form-control" id="ckp_akhir" name="ckp_akhir" placeholder="Masukkan Angka" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" required>
                            </div>
                            <div class="form-group">
