            ...
            <div class="row mb-8">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="ketstaf" class="form-control" id="ketstaf"
                            placeholder="Lorem Ipsum Dolor Sit Amet">
                    </div>
                    <div class="form-group">
                        <label for="ketpenilai">Keterangan Penilai</label>
                        <input type="ketpenilai" class="form-control" id="ketpenilai"
                            placeholder="Lorem Ipsum Dolor Sit Amet">
                    </div>
                    <div class="form-group">
                        <label for="penilai">Penilai</label>
                        <input type="penilai" class="form-control" id="penilai"
                            placeholder="Lorem Ipsum Dolor Sit Amet">
                    </div>
                </div>
            </div>
