...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form id="myForm" action="/kepalabps-perencanaankerja/penilaianskp/store" method="POST">
            @csrf
            <div class="row mb-8">
                <div class="col-sm-12">
            ...
            <div class="row mb-8">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" data-width="75%" data-live-search="true" id="kuantitas_kondisi" name="kuantitas_kondisi" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kuantitas_realisasi" name="kuantitas_realisasi" placeholder="Masukkan Angka" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" required>
                    </div>
                </div>
            </div>
