...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 d-flex justify-content-end align-items-center mb-2">
                <a href="/kf-perencanaankerja/penilaianskp/create/index" type="button" class="btn add-button">+Tambah</a>
                                ...
                                @forelse ($resultrole as $skp)
                                    @if ($skp->kinerja == 'utama')
                                        <tr>
                                            ...
                                            <td rowspan="3">
                                                <button class="btn btn-icon btn-delete btn-sm" data-delete-url="{{ route('kf.penilaianskp.delete', ['id' => $skp->id]) }}">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <!-- Form input data -->
                                            <form action="/kf-perencanaankerja/penilaianskp/print">
    ...
    <script>
        ...
        function handleSearch(value, unitkerjavalue, kinerjavalue) {
            $.ajax({
                type: 'get',
                url: '{{ URL::to('/kf-perencanaankerja/penilaianskp/search') }}',
                data: {
                    'search': value,
