...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- Content Row -->
        <form id="myForm" action="/kf-masteruraiankegiatan/uraiankegiatan/store" method="POST">
            @csrf
            <div class="row mb-8">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        @foreach ($user as $users)
                            @if ($users->id == $userid)
                                <input type="pembuat" class="form-control col-sm-12" id="pembuat" placeholder="Lorem Ipsum" name="pembuat" value="{{ $users->nama }}" disabled>
