    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 d-flex justify-content-end align-items-center mb-2">
                <a href="/kf-perencanaankerja/rencanakinerja/create/index" type="button" class="btn add-button">+
                    Tambah</a>
            </div>
        </div>
                        ...
                        <tbody class="alldata">
                            @forelse ($rencanakinerja as $rencana)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-icon btn-edit btn-sm">
                                            <a href="{{ route('kf.kuantitas.edit', ['id' => $rencana->id]) }}"
                                    ...
                                    <td rowspan="3">
                                        <button class="btn btn-icon btn-edit btn-sm">
                                            <a href="{{ route('kf.rencanakinerja.edit', ['id' => $rencana->id]) }}" class="action-link"><i class="fas fa-edit"></i></a>
                                        </button>
                                        <button class="btn btn-icon btn-delete btn-sm" data-delete-url="{{ route('kf.rencanakinerja.delete', ['id' => $rencana->id]) }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-icon btn-edit btn-sm">
                                            <a href="{{ route('kf.kualitas.edit', ['id' => $rencana->id]) }}"
                                                class="action-link"><i class="fas fa-edit"></i></a>
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-icon btn-edit btn-sm">
                                            <a href="{{ route('kf.waktu.edit', ['id' => $rencana->id]) }}"
                                                class="action-link"><i class="fas fa-edit"></i></a>
                                        </button>
                                    </td>
                                </tr>
