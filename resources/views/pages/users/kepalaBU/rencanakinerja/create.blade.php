...
@section('content')
    ...
    <div class = "container-fluid">
        ...
        <form id="myForm" action="/kepalabu-perencanaankerja/rencanakinerja/store" method="POST">
            @csrf
            <div class="row mb-8">
                <div class="col-sm-12">
                    <div class="form-group d-flex align-items-center">
                        ...
                        @foreach ($user as $users)
                            @if ($users->id == $userid)
                                <input type="nama" class="form-control col-sm-11" id="nama" placeholder="Lorem Ipsum" name="nama" value="{{ $users->nama }}" disabled="disabled">
                    ...
                    <div class="form-group d-flex align-items-center">
                        ...
                        <input type="periode" class="form-control col-sm-11" id="tahun" value="{{ $skptahunan->tahun }}" name="tahun" disabled="disabled">
                    </div>

                    <div class="form-group d-flex align-items-center">
                        <label for="periode" class="col-sm-1 pl-0 col-form-label">Periode</label>
                        <input type="periode" class="form-control col-sm-11" id="periode" value="{{ $skptahunan->periode }}" name="periode" disabled="disabled">
                    </div>

                    <div class="form-group d-flex align-items-center">
                        <label for="periode" class="col-sm-1 pl-0 col-form-label">Wilayah</label>
                        <input type="periode" class="form-control col-sm-11" id="wilayah" value="{{ $skptahunan->wilayah }}" name="wilayah" disabled="disabled">
                    </div>

                    <div class="form-group d-flex align-items-center">
                        <label for="periode" class="col-sm-1 pl-0 col-form-label">Unit Kerja</label>
                        <input type="periode" class="form-control col-sm-11" id="unit kerja" value="{{ $skptahunan->unit_kerja }}" name="unit_kerja" disabled="disabled">
                    </div>

                    <div class="form-group d-flex align-items-center">
                        <label for="kinerja" class="col-sm-1 pl-0 col-form-label">Kinerja</label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="kjutama" value="utama" name="kinerja" onclick="toggleCheckbox('kjutama')" required>
                            <label class="form-check-label" for="inlineCheckbox1">Utama</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="kjtambahan" value="tambahan" name="kinerja" onclick="toggleCheckbox('kjtambahan')" required>
            ...
            <div class="row mb-8">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="rkatasan" class="form-control" id="rkatasan" placeholder="Lorem Ipsum Dolor Sit Amet" name="rencana_kinerja_atasan" required>
                    </div>
                    <div class="form-group">
                        <label for="rkpegawai">Rencana Kinerja</label>
                        <input type="rkpegawai" class="form-control" id="rkpegawai" placeholder="Lorem Ipsum Dolor Sit Amet" name="rencana_kinerja" required>
                    </div>
                </div>
            </div>
