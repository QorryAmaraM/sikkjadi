    ...
    <div class="container-fluid">
        ...
        @foreach ($result as $result)
            @if ($result->penilaian_ckpr_id == null)
                <form id="myForm" action="/kepalabu-monitoring/monitoringckp/store" method="POST">
                    @csrf
                    <div class="row mb-8">
                        <div class="col-sm-12">
            ...
            @else
                <form id="myForm" action="/kepalabu-monitoring/monitoringckp/{{ $nilai_ckpr_id }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="row mb-8">
                        <div class="col-sm-12">
