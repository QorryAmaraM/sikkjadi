...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item {{ request()->is('staf_dashboard*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('staf_dashboard') }}">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('staf_skptahunan') }}">
                    <p class="sub-nav-text">
                        <i class="fas fa-bookmark"></i>SKP Tahunan
                    </p>
                </a>
                <a class="collapse-item" href="{{ route('staf_rencanakinerja') }}">
                    <p class="sub-nav-text">
                        <i class="fas fa-bookmark"></i>Rencana Kinerja
                    </p>
                </a>
                <a class="collapse-item" href="{{ route('staf_penilaianskp') }}">
                    <p class="sub-nav-text">
    ...
    <li class="nav-item">
        ...
        <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="{{ route('staf_listangkakredit') }}">
                    <p class="sub-nav-text">
                        <i class="fas fa-bookmark"></i>List Angka Kredit
                    </p>
                </a>
                <a class="collapse-item" href="{{ route('staf_entriangkakredit') }}">
                    <p class="sub-nav-text">
    ...
    <li class="nav-item">
        ...
        <div id="collapse4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="{{ route('staf_uraiankegiatan') }}">
                    <p class="sub-nav-text">
    ...
    <li class="nav-item">
        ...
        <div id="collapse5" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="{{ route('staf_ckpt') }}">
                    <p class="sub-nav-text">
                        <i class="fas fa-bookmark"></i>CKP-T
                    </p>
                </a>
                <a class="collapse-item" href="{{ route('staf_ckpr') }}">
                    <p class="sub-nav-text">
                        <i class="fas fa-bookmark"></i>CKP-R
                    </p>
                </a>
                <a class="collapse-item" href="{{ route('staf_penilaianckpr') }}">
                    <p class="sub-nav-text">
    ...
    <li class="nav-item">
        ...
        <div id="collapse6" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <h6 class="collapse-header">Custom Components:</h6> --}}
                <a class="collapse-item" href="{{ route('staf_monitoringckp') }}">
                    <p class="sub-nav-text">
                        <i class="fas fa-bookmark"></i>Monitoring CKP
                    </p>
                </a>
                <a class="collapse-item" href="{{ route('staf_monitoringpre') }}">
                    <p class="sub-nav-text">
